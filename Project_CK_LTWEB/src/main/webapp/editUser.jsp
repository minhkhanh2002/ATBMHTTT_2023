...
<link rel="icon" type="image/png" sizes="16x16"
	href="admin/plugins/images/favicon.png">
<!-- Custom CSS -->
		...
		<div class="page-wrapper">
			...
			<div class="container-fluid">
				...
				<div class="col-md-12">
					<div class="card">
						<div class="card-body">
							<form class="form-horizontal form-material" action="<%=request.getContextPath()%>/changeInfor"
								method="post">

								<div class="form-group mb-4">
									<label class="col-md-12 p-0"><b>Họ và tên </b></label>
									<div class="col-md-12 border-bottom p-0">
										<input type="text" class="form-control p-0 border-0" value="${user.fullName}"
											name="userFullname">
									</div>
								</div>
								...
								<div class="form-group">
									<label for="sel1"><b>Tỉnh/Thành Phố: </b></label> <select
								...
								<div class="form-group">
									<label><b>Quận/Huyện: </b></label> <select class="form-control"
								...
								<div class="form-group">
									<label><b>Phường/Xã: </b></label> <select class="form-control"
										id="ward" name="ward" required="required">
										<option value="" selected><%=addressWard%></option>
									</select>
								</div>

								<label class="form-label" for="form3Example4cdg"><b>Địa chỉ
									chi tiết: </b></label>
								...
								<div class="form-group mb-4">
									<div class="col-sm-12">
										<button type="submit" name="updateUser" class ="btn btn-success" id ="btn_update">Cập nhật</button>
										<a class="btn btn-primary"
											href="<%=request.getContextPath()%>/changeInfor">Quay lại</a>
									</div>
								</div>
							</form>
						</div>
