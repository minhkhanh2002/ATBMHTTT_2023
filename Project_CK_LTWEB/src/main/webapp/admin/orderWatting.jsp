									...
									<tbody>
										<c:forEach var="o" items="${listOrder}">
											<tr>
												...
												<td>${o.userName }</td>
												<td>${o.date }</td>
												<td><a href ="<%=request.getContextPath()%>/order?action=detail&orderId=${o.orderId }&previous=wating"  class = "btn btn-primary"><i class="ti-eye" title= "Xem"></i></a></td>
