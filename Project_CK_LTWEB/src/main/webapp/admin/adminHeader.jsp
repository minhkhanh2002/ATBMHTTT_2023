...
<head>
	...
	<link href="./themify-icons/themify-icons.css"
		  rel="stylesheet">
					...
					<ul class="navbar-nav ms-auto d-flex align-items-center">
						...
						<li>
							<div class="profile-pic">
								<img src="./admin/plugins/images/users/d2.jpg"
				...
				<nav class="sidebar-nav">
					<ul id="sidebarnav">
						...
						<li class="sidebar-item pt-2"><a
								...
								href="<%=request.getContextPath()%>/admin" aria-expanded="false"> <i
...
<%--						</ul>--%>
						<li class="sidebar-item"><a
								class="sidebar-link waves-effect waves-dark sidebar-link"
								href="<%=request.getContextPath()%>/statistical?page=sta_product" aria-expanded="false">
							<i class="ti-receipt" aria-hidden="true"></i> <span
								class="hide-menu">Thống kê sản phẩm bán ra</span>
						</a></li>
						<li class="sidebar-item"><a
								class="sidebar-link waves-effect waves-dark sidebar-link"
								href="<%=request.getContextPath()%>/statistical?page=revenue" aria-expanded="false">
							<i class="ti-receipt" aria-hidden="true"></i> <span
								class="hide-menu">Thống kê doanh thu</span>
						</a></li>
						<!--end thong ke  -->
						...
						<li class="sidebar-item pt-2"><a
								class="sidebar-link waves-effect waves-dark sidebar-link"
								href="<%=request.getContextPath()%>/manager_product?action=main" aria-expanded="false">
							<i class="ti-palette" aria-hidden="true"></i> <span
								class="hide-menu">Quản lí sản phẩm</span>
						</a></li>
						<li class="sidebar-item"><a
								class="sidebar-link waves-effect waves-dark sidebar-link"
								href="<%=request.getContextPath()%>/manager_user" aria-expanded="false">
...
<%--						</a></li>--%>
						<li class="sidebar-item"><a
								class="sidebar-link waves-effect waves-dark sidebar-link"
								href="<%=request.getContextPath()%>/order?action=accept" aria-expanded="false">
							<i class="ti-control-record" aria-hidden="true"></i> <span
								class="hide-menu">ĐH Chờ xác nhận</span>
						</a></li>

						<li class="sidebar-item"><a
								class="sidebar-link waves-effect waves-dark sidebar-link"
								href="<%=request.getContextPath()%>/order?action=wating" aria-expanded="false">
							<i class="ti-control-record" aria-hidden="true"></i> <span
								class="hide-menu">ĐH Cờ Vận Chuyển</span>
						</a></li>

						<li class="sidebar-item"><a
								class="sidebar-link waves-effect waves-dark sidebar-link"
								href="<%=request.getContextPath()%>/order?action=move" aria-expanded="false">
							<i class="ti-control-record" aria-hidden="true"></i> <span
								class="hide-menu">ĐH Đang Vận Chuyển</span>
						</a></li>

						<li class="sidebar-item"><a
								class="sidebar-link waves-effect waves-dark sidebar-link"
								href="<%=request.getContextPath()%>/order?action=finish" aria-expanded="false">
							<i class="ti-control-record" aria-hidden="true"></i> <span
								class="hide-menu">ĐH Đã Hoàn Thành</span>
						</a></li>

						<li class="sidebar-item"><a
								class="sidebar-link waves-effect waves-dark sidebar-link"
								href="<%=request.getContextPath()%>/order?action=destroy" aria-expanded="false">
							<i class="ti-control-record" aria-hidden="true"></i> <span
								class="hide-menu">ĐH Đã Huỷ</span>
						</a></li>

<%--						<li class="sidebar-item"><a--%>
<%--								class="sidebar-link waves-effect waves-dark sidebar-link"--%>
<%--								href="/Project_CK_LTWEB/order?action=wating" aria-expanded="false">--%>
<%--							<i class="ti-control-record" aria-hidden="true"></i> <span--%>
<%--								class="hide-menu">ĐH Chờ vận chuyển</span>--%>
<%--						</a></li>--%>
...
<%--						</ul>--%>
						...
						<li class="sidebar-item"><a
								class="sidebar-link waves-effect waves-dark sidebar-link"
								href="<%=request.getContextPath()%>/ManagerFeedback" aria-expanded="false">
							<i class="ti-ruler-pencil" aria-hidden="true"></i> <span
								class="hide-menu">Quản lí phản hồi</span>
						</a></li>
						<li class="sidebar-item"><a
								class="sidebar-link waves-effect waves-dark sidebar-link"
								href="<%=request.getContextPath()%>/manager_log" aria-expanded="false">
							<i class="ti-map-alt" aria-hidden="true"></i> <span
								class="hide-menu">Log</span>
						</a></li>
						<li class="sidebar-item"><a
								class="sidebar-link waves-effect waves-dark sidebar-link"
								href="<%=request.getContextPath()%>/404.html" aria-expanded="false"> <i
						...
						<li class="text-center p-20 upgrade-btn"><c:set var="logOut"
								...
								href="<%=request.getContextPath()%>/login?logOut=${logOut}"
				...
				<div class="row align-items-center">
					...
					<div class="col-lg-9 col-sm-8 col-md-8 col-xs-12">
						<div class="d-md-flex">
							...
							<a href="<%=request.getContextPath()%>/login?logOut=${logOut}"
