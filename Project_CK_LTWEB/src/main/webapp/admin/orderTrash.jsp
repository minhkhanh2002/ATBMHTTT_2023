									...
									<tbody>
										<c:forEach var="o" items="${listOrder}">
											<tr>
												...
												<td>${o.userName }</td>
												<td>${o.date }</td>
												<td><a href ="<%=request.getContextPath()%>/order?action=detail&orderId=${o.orderId }&previous=destroy"  class = "btn btn-primary"><i class="ti-eye" title= "<fmt:message key="order.detail"
